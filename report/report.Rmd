...
```{r echo=FALSE}
# Clearing R environment before proceeding. 
rm(list = ls())
```
...
Proposal phase: all members met in person to discuss which data set to use for the project. All members have added and edited a Google doc that is shared among all members. This document had information such as what data to use, information of data, possible questions we can choose to answer in this project. 

Analysis phase: Every member had a question assigned to answer. 

- Ardavan: question 1
- Frederick: question 2
- Armaan: question 3

Every member has contributed in both presentation preparation, the presentation itself, and the report. Every member has added their corresponding question and the analysis and everyone was assigned one extra part from: introduction, data preparation, and conclusion. 

- Ardavan: introduction
- Frederick: data preparation
- Armaan: conclusion

Overall, the amount of works among the members were fair and we all learned a lot from the project. 
